...
- `insights_item_shop_comparison.png`: show Shop comparison for one item across two demo shops, with separate daily lines, shop totals, and the scoped shop selector. Needed by all five locales after release.
