...
- [Info Settings](./general-info.md): update branch identity, address, contact details, and timezone.
- [Workday Schedule](./workday-schedule.md): define business-day timing and service periods.
...
- You need to edit `System Parameters` without a known safe value.
